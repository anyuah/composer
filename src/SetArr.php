...
class SetArr
{
     ...
     */
    function results_preg_replace(array $data_mac, string $template_str)
    {
     ...
     * @return array
     */
    function results_int(array $data)
    {
     ...
     * @return array|object
     */
    function results_pids(array $data)
    {
        if(empty($data))
            return $data;
     ...
     * @return array|mixed
     */
    function get_value_field($results = [], $args = [], $field = '', $type = 0)
    {
     ...
     */
    function array_filter_keys($data = [], $keys = [])
    {
     ...
     * @return array
     */
    function unset_array_value(array &$arr,$val)
    {
     ...
     */
    function set_array_ele($data = [],$addArr = []){
